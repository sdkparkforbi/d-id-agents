...
with st.sidebar:
    ...
    """
    components.html(did_html, height=400)
...
with tab2:
    ...
    if track == "경영기획 트랙":
        ...
        st.metric(label="졸업생 진출", value="102명")
        ...
        st.metric(label="졸업생 진출", value="30명")
        ...
        st.metric(label="졸업생 진출", value="42명")
        ...
        st.metric(label="바이오헬스케어 취업률", value="24.5%")
...
with tab3:
    ...
    with col1:
        ...
        for industry, percent in data.items():
            st.progress(percent/100, text=f"{industry}: {percent}%")
...
with tab4:
    ...
    with col1:
        ...
        st.write("- 스포츠마케팅")
        st.write("- 스포츠 구단 경영")
        st.write("- 헬스케어 서비스 운영")
        
        st.write("### 🧬 경영학 + 바이오식의약학")
        st.write("- 바이오 비즈니스")
        st.write("- 제약 마케팅")
        st.write("- R&D-사업개발 연결")
    
    with col2:
        st.write("### 🏥 경영학 + 디지털보건의료")
        st.write("- 병원 운영/경영기획")
        st.write("- 디지털헬스 제품 PM")
        st.write("- 글로벌 헬스케어 전문가")
        
        st.write("### 🤖 경영학 + AI의료데이터학")
        st.write("- 헬스케어 데이터 애널리스트")
        st.write("- 리얼월드데이터 분석")
        st.write("- 의료 AI 서비스 기획")
